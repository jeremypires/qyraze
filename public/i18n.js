(function () {
  ...
  window.QyrazeDemoStrings = {
    en: {
      ...
      score: 'Lead score',
      typing: 'Typing…',
      empty_prompt: 'Pick a profile above, then write as a prospect — or tap a suggestion below.',
      pick_profile_placeholder: 'Choose a profile above to start…',
      ...
      send: 'Send',
      note: 'Demo only — switch profile anytime. Simulates Instagram DMs + Telegram alert.',
      profiles_label: 'Who do you want to talk to?',
      error: 'Demo temporarily unavailable. Try again shortly.',
      section_kicker: 'Live demo',
      section_title: 'Find the profile that fits you',
      section_sub: 'Five real personas — Jeremy\u2019s assistant, a lawyer, a coach, a wellness studio, a pizzeria. Chat as a prospect and watch the AI qualify.',
      ...
      profiles: {
        ...
        premium: {
          name: 'Pascal · Lawyer',
          tagline: 'Law firm — calm, premium tone.',
        },
        closer: {
          name: 'Alex · Business coach',
          tagline: 'Coaching — fast, results-driven.',
        },
        companion: {
          name: 'Elise · Wellness',
          tagline: 'Yoga studio — warm and caring.',
        },
        efficient: {
          name: 'Marco · Pizzeria',
          tagline: 'Catering & orders — straight to the point.',
        },
      },
    },
    fr: {
      ...
      score: 'Score lead',
      typing: 'Écriture…',
      empty_prompt: 'Choisissez un profil ci-dessus, puis écrivez comme un prospect — ou touchez une suggestion.',
      pick_profile_placeholder: 'Choisissez un profil pour commencer…',
      ...
      send: 'Envoyer',
      note: 'Démo uniquement — changez de profil à tout moment. Simule DM Instagram + alerte Telegram.',
      profiles_label: 'Avec qui voulez-vous discuter ?',
      error: 'Démo temporairement indisponible. Réessayez dans un instant.',
      section_kicker: 'Démo live',
      section_title: 'Trouvez le profil qui vous ressemble',
      section_sub: 'Cinq personnages concrets — mon assistant, un avocat, un coach, un studio bien-être, une pizzeria. Discutez comme un prospect et voyez l\u2019IA qualifier.',
      ...
      profiles: {
        ...
        premium: {
          name: 'Pascal · Avocat',
          tagline: 'Cabinet juridique — ton posé et rassurant.',
        },
        closer: {
          name: 'Alex · Coach',
          tagline: 'Coaching business — dynamique et direct.',
        },
        companion: {
          name: 'Élise · Bien-être',
          tagline: 'Studio yoga — douceur et écoute.',
        },
        efficient: {
          name: 'Marco · Pizzeria',
          tagline: 'Traiteur & commandes — efficace, sans blabla.',
        },
      },
    },
  };
